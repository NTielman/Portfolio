        ...
        <section className='about page' id='about'>
            ...
            <div
                ...
                <article className='about-text'>
                    ...
                    <ul>
                        <em>
                            <li>I love to learn new skills</li>
                            <li>I enjoy watching cartoons <br /> <small>(Rick & Morty and Gravity Falls are some of my favorites)</small></li>
                            <li>I speak 5 languages</li>
                            <li>I'm addicted to sushi</li>
