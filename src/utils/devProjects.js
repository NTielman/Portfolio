const grocery_helper = {
    ...
    shortDescription:
        "A web app that keeps track of your groceries list and cart items",
    longDescription:
        "A web application that keeps track of your grocery list and the items already in your cart.",
...
const lil_playlist = {
    ...
    longDescription:
        "A single-page application (SPA) that allows you to add, sort, filter, and organize your music.",
...
const student_dashboard = {
    ...
    longDescription:
        "Built a dashboard that displays how satisfied students are with the assignments they received from their university/ academy, using charts and tables to visualize the data.",
...
const wincHackathon = {
    ...
    shortDescription:
        "Hackathon project - creating a button with surprising effects",
    longDescription:
...
const tarot = {
    ...
    shortDescription:
        "Find out what the future holds for you with this Tarot reader",
    longDescription:
...
const hamiltonApi = {
    ...
    shortDescription:
        "A RESTful API containing information on the Hamilton musical",
    longDescription:
...
const bravoure = {
    title: "Bravoure Projects",
    videoDemoUrl: "https://www.youtube.com/watch?v=6A8KPTlc6C4",
    shortDescription:
        "Projects completed for various clienst of Bravoure (internship company)",
    longDescription:
        "During my internship at Bravoure I got the chance to implement new features for various client projects in the arts and entertainment industries. these features and functionalities include: Adding an infinite scroll, login pop-up, donation and application forms, implementing site re-designs, building card sliders, favourite/unfavoriting functionality, adding effects and transitions to user interactions, form validations, etc.",
    tools: [
        "Vue",
        "Node",
        "GraphQL",
    ...
    image: "/assets/images/projects/devProjects/bravoure.jpg",
    webpImage: "/assets/images/projects/devProjects/bravoure.webp",
    key: 9,
};

const mediaMarktSaturn = {
    title: "MediaMarkt Saturn",
    videoDemoUrl: "https://www.youtube.com/watch?v=vBBx0x-o-2o",
    shortDescription:
        "Built new loyalty and personalization features for the global mobile app",
    longDescription:
        "Supported the in-house team with building new loyalty and personalization features for the global mobile app. Developed backward compatible components and features in MVVM, Service Locator, and Repository patterns, using GraphQL to fetch data and Contentful integration for tailoring. Wrote unit and integration tests for new features. Debugged and fixed failing pipelines",
    tools: ["Dart", "Flutter", "GraphQL", "Firebase", "Contentful"],
    image: "/assets/images/projects/devProjects/mms.jpeg",
    webpImage: "/assets/images/projects/devProjects/mms.webp",
    key: 10,
};
